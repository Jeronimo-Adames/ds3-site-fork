<script lang='ts'>
    ...
    export const title = "Board | DS3 at UCSD";
    export const description = "Learn about the brilliant minds behind DS3 - meet the team of dedicated undergraduates leading the charge.";
</script>
